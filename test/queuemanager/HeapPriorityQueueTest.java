...
/**
 * Testing was done using the GeeksForGeeks Tutorial. The code on the website was
 * edited, and the resulting heap order was used as the expected result
 * @author Jonah
 */
public class HeapPriorityQueueTest {
    ...
    public void testAdd3() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(Indonesia, 79), (Bahamas, 12), (China, 37)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
    ...
    public void testAdd4() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(Norway, 130), (Japan, 86), (Belgium, 17), (Denmark, 47)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
    ...
    public void testAdd5() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(Norway, 130), (Denmark, 47), (Japan, 86), (United States, -187), (, 17)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
    ...
    public void testRemove1() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(Mexico, 111), (Germany, 65), (Argentina, 7), (Brazil, 24)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
    ...
    public void testRemove2() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(Netherlands, 123), (Australia, 9), (India, 78)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
    ...
    public void testToString1() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(Philippines, 139), (Mexico, 111), (Brazil, 24), (Germany, 65), (Argentina, 7)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
    ...
    public void testToString3() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(United Kingdom, 186), (Indonesia, 79), (North Korea, 128), (Bahamas, 12), (China, 37)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
    ...
    public void testToString4() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(United States, 187), (Japan, 86), (Norway, 130), (Belgium, 17), (Denmark, 47)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
    ...
    public void testToString5() throws Exception {
        ...
        // Creating the expected result string
        Object expResult = "[(United States, 187), (Norway, 130), (Denmark, 47), (Belgium, 17), (Japan, 86)]";
        // Getting the result that the method creates
        Object result = instance.toString();
        // Testing whether the expected result and result are equal to each other
        assertEquals(expResult, result);
